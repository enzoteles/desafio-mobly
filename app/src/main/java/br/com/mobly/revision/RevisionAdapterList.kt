...
import kotlinx.android.synthetic.main.revision_item_list.view.*


class RevisionAdapterList(val articles: MutableList<ArticlesItem>, val context: Context) : RecyclerView.Adapter<RevisionAdapterList.ViewHolder>() {
